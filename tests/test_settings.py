...
from env_wrangler.settings import copy_file
from env_wrangler.settings import get_config_value_as_list
...
def test_copy_file(tmp_path):
    ...
    # Call copy_file with the source file name and a destination path
    copy_file("test.txt", str(tmp_path / "dest" / "test.txt"))
